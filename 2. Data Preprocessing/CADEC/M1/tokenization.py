...
def parse_parameters(parser=None):
    ...
    #輸入標註文字檔案
    parser.add_argument("--input_dir", default="./data/Corpora/CADEC/text", type=str)
    #輸出Token標記化結果(以字符跨度)
    parser.add_argument("--output_filepath", default="./data/Experiments/CADEC/tokens", type=str)
