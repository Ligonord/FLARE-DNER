...
def parse_parameters(parser=None):
    ...
    # train
    # parser.add_argument("--input_dir", default="./train/ann", type=str)
    # parser.add_argument("--text_dir", default="./train/text", type=str)
    # parser.add_argument("--split", default="train", type=str)
    
    # test
    parser.add_argument("--input_dir", default="./test/ann", type=str)
    parser.add_argument("--text_dir", default="./test/text", type=str)
