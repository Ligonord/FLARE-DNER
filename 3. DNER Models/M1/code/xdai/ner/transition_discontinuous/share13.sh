...
do
  python train.py --output_dir ../../../../data/Experiments/share13/$seed \
  --train_filepath ../../../../data/Experiments/share13/train.txt \
  --dev_filepath ../../../../data/Experiments/share13/dev.txt \
  --test_filepath ../../../../data/Experiments/share13/test.txt \
  --log_filepath ../../../../data/Experiments/share13/$seed/train.log \
