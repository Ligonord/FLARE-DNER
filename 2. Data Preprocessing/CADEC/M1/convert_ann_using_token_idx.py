...
def parse_parameters(parser=None):
    ...
    #輸入全部檔案標註結果(extract_annotations.py的結果)
    parser.add_argument("--input_ann", default="./data/Experiments/CADEC/ann", type=str)
    #輸入Token標記化結果(tokenization.py的結果)
    parser.add_argument("--input_tokens", default="./data/Experiments/CADEC/tokens", type=str)
    
    #輸出全部檔案標註&標記(以索引Index)的結果
    parser.add_argument("--output_ann", default="./data/Experiments/CADEC/tokens.ann", type=str)
