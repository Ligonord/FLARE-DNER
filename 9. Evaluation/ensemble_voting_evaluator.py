...
if dataset == 'cadec':
    ...
    vote_data = json.load(open(f'./ensemble_voting/{dataset}_voting_{threshold}.json', "r", encoding="utf-8"))
else:
    ...
    # vote_data = json.load(open(f'./ensemble_voting/{dataset}_voting_{threshold}.json', "r", encoding="utf-8"))
    vote_data = json.load(open(f'./ensemble_voting/{dataset}_voting_{threshold}_fixed.json', "r", encoding="utf-8"))
...
vote_entity_text = []
for d in vote_data:
    vote_entity_offset.append(d["ner_offset"])
    vote_entity_text.append(d["ner_text"])

print('Micro-F1 Offset:')
p, r, f1 = evaluate_offset(gold_entity_offset, vote_entity_offset, 'all')
print(f"Precision: {p:.4f}, Recall: {r:.4f}, F1: {f1:.4f}")
p, r, f1 = evaluate_offset(gold_entity_offset, vote_entity_offset, 'with_disc')
print(f"Precision: {p:.4f}, Recall: {r:.4f}, F1: {f1:.4f}")
p, r, f1 = evaluate_offset(gold_entity_offset, vote_entity_offset, 'only_disc')
print(f"Precision: {p:.4f}, Recall: {r:.4f}, F1: {f1:.4f}")
p, r, f1 = evaluate_offset(gold_entity_offset, vote_entity_offset, 'only_c')
print(f"Precision: {p:.4f}, Recall: {r:.4f}, F1: {f1:.4f}")
print()

print('Micro-F1 Text:')
p, r, f1 = evaluate_text(gold_entity_text, vote_entity_text, sentence, 'all')
print(f"Precision: {p:.4f}, Recall: {r:.4f}, F1: {f1:.4f}")
p, r, f1 = evaluate_text(gold_entity_text, vote_entity_text, sentence, 'with_disc')
print(f"Precision: {p:.4f}, Recall: {r:.4f}, F1: {f1:.4f}")
p, r, f1 = evaluate_text(gold_entity_text, vote_entity_text, sentence, 'only_disc')
print(f"Precision: {p:.4f}, Recall: {r:.4f}, F1: {f1:.4f}")
p, r, f1 = evaluate_text(gold_entity_text, vote_entity_text, sentence, 'only_c')
print(f"Precision: {p:.4f}, Recall: {r:.4f}, F1: {f1:.4f}")
print()

relaxed_matching(gold_entity_offset, vote_entity_offset)
print()
relaxed_matching_jaccard_hungarian(gold_entity_offset, vote_entity_offset)
print()
token_coverage(gold_entity_offset, vote_entity_offset)
print()
entity_f1_offset(gold_entity_offset, vote_entity_offset)
print()
sen_instance_f1(gold_entity_offset, vote_entity_offset)