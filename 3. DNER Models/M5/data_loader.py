...
def load_data_bert(config):
    with open('./data/{}/train_data.json'.format(config.dataset), 'r', encoding='utf-8') as f:
        train_data = json.load(f)
    with open('./data/{}/valid_data.json'.format(config.dataset), 'r', encoding='utf-8') as f:
        dev_data = json.load(f)
    with open('./data/{}/test_data.json'.format(config.dataset), 'r', encoding='utf-8') as f:
