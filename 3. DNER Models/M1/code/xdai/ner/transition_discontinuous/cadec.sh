...
do
  python train.py --output_dir ../../../../data/Experiments/cadec/$seed \
  --train_filepath ../../../../data/Experiments/cadec/train.txt \
  --dev_filepath ../../../../data/Experiments/cadec/dev.txt \
  --test_filepath ../../../../data/Experiments/cadec/test.txt \
  --log_filepath ../../../../data/Experiments/cadec/$seed/train.log \
