...
function(p) {
  ...
  train_data_path: "./data/share13/train.json",
  validation_data_path: "./data/share13/dev.json",
  test_data_path: "./data/share13/test.json",
  model: model,
  iterator: {
    type: "ie_batch",
  ...
  trainer: {
    ...
    grad_norm: 5.0,
    patience : p.patience,
    cuda_device : [std.parseInt(x) for x in std.split("0", ",")],
