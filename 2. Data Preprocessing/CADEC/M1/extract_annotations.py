...
def parse_parameters(parser=None):
    ...
    #輸入標註實體檔案
    parser.add_argument("--input_ann", default="./data/Corpora/CADEC/original", type=str)
    #輸入標註文字檔案
    parser.add_argument("--input_text", default="./data/Corpora/CADEC/text", type=str)
    #輸出全部檔案標註結果
    parser.add_argument("--output_filepath", default="./data/Experiments/CADEC/ann", type=str)
